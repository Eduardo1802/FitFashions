...
export const AdminInicio = () => {
  ...
  console.log("vista consultador: id del usuario =>", user.uid);
        ...
        <Grid container sx={{ position: "relative", bottom: "70px",  marginTop: "100px", justifyContent:"center" }}>
          ...
          <Grid item md={3} sm={12} xs={12}>
            <Box sx={{ height: "100%", display: "flex", alignItems: "flex-end", p: 3, justifyContent:"center" }}>
              <Button variant="contained" startIcon={<EditIcon/>} color="secondary" aria-label='abrir ventana para editar el perfil' onClick={activarMensajes}>Generar Token</Button>
              {/* <ToastContainer> */}
